...
#define panBattery_A_Percent_en_ADDR 152
#define panBattery_A_Percent_x_ADDR 154
#define panBattery_A_Percent_y_ADDR 156
...
#define OSD_Toggle_ADDR 906
#define overalt_ADDR 908
