          ...
          if ((millis() - 10000) > warning_timer ) warning = 0;
            ...
            while (warning_type == 0) { // cycle through the warning checks
                ...
                case 4:
                    ...
                    break;
                case 5:
                    if (rssi < 3 && rssi != -99 ) warning_type = 5;
                    break;    
                }
...
void panLogo(){
    osd.setPanel(5, 5);
    osd.openPanel();
    osd.printf_P(PSTR("\x20\x20\x20\x20\x20\xba\xbb\xbc\xbd\xbe|\x20\x20\x20\x20\x20\xca\xcb\xcc\xcd\xce|MinimOSD Extra|2.1 Pre-Release|r168"));
    osd.closePanel();
}
