...
void readSettings(uint8_t panel) {
    ...
    setBit(panA_REG, Bp_BIT, readEEPROM(panBatteryPercent_en_ADDR + offset));
    ...
    setBit(panB_REG, Rose_BIT, readEEPROM(panRose_en_ADDR + offset));
    panRose_XY[0][panel] = readEEPROM(panRose_x_ADDR + offset);
    panRose_XY[1][panel] = checkPAL(readEEPROM(panRose_y_ADDR + offset));

    setBit(panB_REG, Head_BIT, readEEPROM(panHeading_en_ADDR + offset));
    ...
    setBit(panB_REG, MavB_BIT, readEEPROM(panMavBeat_en_ADDR + offset));
    ...
    setBit(panB_REG, HDis_BIT, readEEPROM(panHomeDis_en_ADDR + offset));
    ...
    setBit(panB_REG, HDir_BIT, readEEPROM(panHomeDir_en_ADDR + offset));
    ...
    setBit(panB_REG, Time_BIT, readEEPROM(panTime_en_ADDR + offset));
    ...
    setBit(panC_REG, CurA_BIT, readEEPROM(panCur_A_en_ADDR + offset));
    ...
    setBit(panC_REG, Alt_BIT, readEEPROM(panAlt_en_ADDR + offset));
    panAlt_XY[0][panel] = readEEPROM(panAlt_x_ADDR + offset);
    panAlt_XY[1][panel] = checkPAL(readEEPROM(panAlt_y_ADDR + offset));

    setBit(panC_REG, Halt_BIT, readEEPROM(panHomeAlt_en_ADDR + offset));
    ...
    setBit(panC_REG, As_BIT, readEEPROM(panAirSpeed_en_ADDR + offset));
