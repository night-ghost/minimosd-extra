...
adaptaion of MWII/CleanFlight/BaseFlight protocol

all protocol files from KV_Team_OSD project
...
#ifndef CLEANFLIGHT_H_
#define CLEANFLIGHT_H_
#include "Arduino.h"
// ---------------------------------------------------------------------------------------
...
// crazy MWII vars in free space of MAVlink buffer
